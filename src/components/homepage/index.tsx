          ...
          <div className=" w-full flex py-8 lg:space-x-8 max-lg:flex-col ">
            <div className="w-[60%] mx-auto max-lg:w-[100%] ">
                {/* <iframe
                  ...
                  allowFullScreen
                ></iframe> */}
                <iframe className=" rounded-lg h-full m-0 max-md:h-[60vh] max-lg:h-[50vh] " width="100%" height="100%" src="https://www.youtube.com/embed/y89CQgdgrio" title="Alpha Walkthrough 2023" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
            </div>
            <div className=" w-[40%] max-lg:w-[100%] max-lg:pt-8 ">
              ...
              <ul className=" list-disc py-4 space-y-4 lg:text-[1.2rem] max-lg:text-[1.1rem] md:max-lg:text-[1.2rem] ">
                ...
                <li>
                  ...
                  has shown to us and welcoming them into our family. Church is
                  a place to call home.
                </li>
                <li>
                  ...
                  We&apos;d love to walk with you on that journey - find out
                  more here.
                </li>
              </ul>
              <ButtonA
